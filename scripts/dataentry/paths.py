...
URL_PROGRAMME = "https://docs.google.com/spreadsheets/d/1aPkwF8tzyFJleGpstb25PUs21MRYg6mRQci6KbaHmgk/export?format=xlsx"
# URL_PROGRAMME = "https://docs.google.com/spreadsheets/d/1htMkH_W3gE48c-wEdtt-oEI1S9M-Yf0nlyh9FuGAHOw/export?format=xlsx" original below has removed duplicate posters
PATH_PROGRAMME = PATH_DOWNLOADS / "programme.xlsx"

URL_ACCEPTED_SUBMISSIONS = "https://docs.google.com/spreadsheets/d/1MURZmp6AVP1PhE49mP2OvZ-wPrulRPQeYVYGyRpgTXI/export?format=csv"
PATH_ACCEPTED_SUBMISSIONS = PATH_DOWNLOADS / "accepted_submissions.csv"
...
def download_programme():
    download_file(URL_PROGRAMME, PATH_PROGRAMME)


def download_accepted_submissions():
    download_file(URL_ACCEPTED_SUBMISSIONS, PATH_ACCEPTED_SUBMISSIONS)
